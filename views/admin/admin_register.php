...
<div class="container">
    ...
    <form action="" id="add_admin">
        ...
        <input type="number" id="admin_phone" required>
        <br><br>

        <label for="admin_dob">Date of Birth:</label><br>
        <input type="date" id="admin_dob" required>
        <br><br>
        ...
        <input type="password" id="admin_pass" placeholder="Enter a Password (minimum 8 characters)" required>
        <br><br>
    ...
    <p>Go <a href="dashboard.php">back</a></p>
</div>
